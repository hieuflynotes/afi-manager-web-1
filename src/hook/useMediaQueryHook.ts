...
export function useMediaQueryHook(props: PropsUseQueryHook) {
    ...
    useEffect(() => props.onUpHidpi && (!!upHipi as any) && props.onUpHidpi(), [upHipi]);
    useEffect(() => props.onUpXl && (!!upXl as any) && props.onUpXl(), [upXl]);
    useEffect(() => props.onDownXs && (!!downXs as any) && props.onDownXs(), [downXs]);
    useEffect(() => props.onDownSm && (!!downSm as any) && props.onDownSm(), [downSm]);
    useEffect(() => props.onDownMd && (!!downMd as any) && props.onDownMd(), [downMd]);
    useEffect(() => props.onDownLg && (!!downLg as any) && props.onDownLg(), [downLg]);
    useEffect(() => props.onDownHidpi && (!!downHipi as any) && props.onDownHidpi(), [downHipi]);
    useEffect(() => props.onDownXl && (!!downXl as any) && props.onDownXl(), [downXl]);
}
